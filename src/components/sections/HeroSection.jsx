      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[1.08fr_0.92fr] xl:gap-16">
          <div className="relative min-w-0 max-w-4xl">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-x-0 top-6 z-0 h-[36rem] overflow-hidden rounded-[3rem] border border-cyan-300/10 bg-slate-950/40 opacity-90 shadow-2xl shadow-black/30 sm:h-[38rem] lg:hidden"
            >
              <img
                ...
                decoding="async"
                fetchPriority="high"
                className="h-full w-full scale-110 object-cover object-center opacity-28 grayscale"
              />

              <div className="absolute inset-0 bg-gradient-to-r from-slate-950/20 via-slate-950/75 to-slate-950/95" />
...
border-cyan-300/10 bg-slate-950/30 opacity-80 shadow-2xl shadow-black/30 lg:block xl:-left-64"
            >
              <img
                src={assetPaths.personal.heroPhoto}
                alt=""
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-slate-950/10 via-slate-950/75 to-slate-950" />
            ...
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -left-28 top-16 hidden h-72 w-72 rounded-full bg-cyan-300/10 blur-3xl lg:block xl:-left-36"
            />

            <div
              aria-hidden="true"
              className="pointer-events-none absolute -left-8 top-12 hidden h-32 w-24 overflow-hidden rounded-[2rem] border border-cyan-300/20 bg-slate-950/60 p-1 shadow-2xl shadow-black/40 backdrop-blur lg:block xl:-left-12"
            >
              <img
                src={assetPaths.personal.heroPhoto}
                alt=""
                loading="eager"
                decoding="async"
                className="h-full w-full rounded-[1.65rem] object-cover opacity-75 grayscale"
              />
            </div>
          ...
          <Reveal direction="left" delay={0.15} className="relative min-w-0">
            <div className="relative">
              <div
                aria-hidden="true"
                className="pointer-events-none absolute -right-10 -top-10 h-56 w-56 rounded-full bg-cyan-300/10 blur-3xl"
              />

              <Card className="relative z-10 p-0 motion-safe:animate-[floatSoft_7s_ease-in-out_infinite]">
                <div className="relative overflow-hidden rounded-[1.75rem]">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.18),transparent_24rem)]" />
