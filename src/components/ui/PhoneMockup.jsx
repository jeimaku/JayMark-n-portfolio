...
export default function PhoneMockup({
  ...
  return (
    ...
    >
      <div className="relative rounded-[2.6rem] border border-white/15 bg-neutral-950 p-2 shadow-2xl shadow-black/40 transition duration-300 group-hover:-translate-y-1 group-hover:border-neutral-100/40">
        ...
        <div className="relative aspect-[9/19.5] overflow-hidden rounded-[2rem] border border-white/10 bg-black">
          {videoSrc ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-neutral-900 p-6 text-center text-neutral-500">
              <div>
          ...
          <div className="pointer-events-none absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-full border border-white/20 bg-neutral-950/70 text-white backdrop-blur">
